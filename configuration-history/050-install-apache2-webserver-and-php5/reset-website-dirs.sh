...
mkdir -p ${ABS_SITE_DIR}/{web,tmp,session,log} || { echo "Can't mkdir -p the vhost site dir ${ABS_SITE_DIR}/{web,tmp,session} hierarchy"; exit 1; }
...
[ -f ${ABS_SITE_DIR}/web/index.php ] || cat > ${ABS_SITE_DIR}/web/index.php <<DELIMITER
<?php
